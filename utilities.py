...
#############################EDIT CAFFE PATH HERE########################################################
deploy = '/home/solankirahul/caffe/models/bvlc_reference_caffenet/deploy.prototxt'
model = '/home/solankirahul/caffe/models/bvlc_reference_caffenet/bvlc_reference_caffenet.caffemodel'
mean = '/home/solankirahul/caffe/python/caffe/imagenet/ilsvrc_2012_mean.npy'
#########################################################################################################
...
class CNN(object):
    ...
    # This function loads the caffe VGG19 model
    def get_net(self):
        caffe.set_mode_gpu()
    ...
    # This function computes the features of the images and stores in feat array which is then returned. 
